...
A modern, high-performance, single-page luxury jewellery web application showcasing the exclusive **Arwa 53 Collection** of gold bangles, bracelets, and bespoke jewellery pieces. Complete with physical boutique location details, interactive concierge actions, live wishlist drawer, and direct WhatsApp / phone contact integration.

---

## 🌟 Key Features

- **💎 Curated Jewellery Showcase**: Interactive catalog featuring real, high-resolution product photography with shimmer typography and tilt-card hover micro-interactions.
- **📍 Physical Boutique Integration**:
  - Full store address: *Near Mewad Hospital, Just opposite Vaibhav Opticals, Nai Abadi, Banswara, Rajasthan, India*.
  - Interactive Google Maps navigation links.
  - Landmark guide (*Mewad Hospital, Vaibhav Opticals, Nai Abadi Market*).
  - Visiting hours & store timings.
...
- **🔍 Instant Search & Category Filters**: Real-time filtering across bangles, bracelets, bestsellers, and new arrivals.
